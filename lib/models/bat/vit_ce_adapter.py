...
from ..layers.attn_adapt_blocks import CEBlock_twobranch 
...
class VisionTransformerCE(VisionTransformer):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 new_patch_size=None, adapter_type=None, backbone_type=None):
        """
        Args:
        ...
        for i in range(depth):
            ...
            if i < 20:
                ...
                CEBlock_twobranch(
                        ...
                        keep_ratio_search=ce_keep_ratio_i, backbone_type=backbone_type, layer_id=i)
                )
            else:
                blocks.append(
                    DSBlock(
...
###################################################################===========
        ...
        for i, blk in enumerate(self.blocks):
            ...
            if 'mimic' in self.backbone_type and i != 11:
                x, global_index_t, global_index_s, removed_index_s, attn, mimic_x, \
                xi, global_index_ti, global_index_si, removed_index_si, attn_i, mimic_xi = \
                    blk(x, xi, global_index_t, global_index_ti, global_index_s, global_index_si, mask_x, ce_template_mask,
                        ce_keep_rate)
                mimic_token_list.append([mimic_x, mimic_xi])
            else:
                x, global_index_t, global_index_s, removed_index_s, attn, \
                xi, global_index_ti, global_index_si, removed_index_si, attn_i = \
                    blk(x, xi, global_index_t, global_index_ti, global_index_s, global_index_si, mask_x, ce_template_mask,
                        ce_keep_rate)
            inter_res_list.append([x, xi])
