...
#from lib.models.bat_mod_ee.vit_adapter import vit_base_patch16_224_adapter
from lib.models.bat_mod_ee.vit_ce_adapter import vit_base_patch16_224_ce_adapter, vit_base_patch16_224_ce_mimic
...
def build_batrack_mod_ee(cfg, training=True):
    ...
    if cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_adapter':
        backbone = vit_base_patch16_224_adapter('', drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
        ...
        backbone = vit_base_patch16_224_ce_adapter('', drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
                                           ...
                                           new_patch_size=cfg.MODEL.BACKBONE.STRIDE,
                                           adapter_type=cfg.TRAIN.PROMPT.TYPE,
                                           modee_type=cfg.MODEL.MODEE.TYPE,
                                           has_cls_token=cfg.MODEL.MODEE.HAS_CLS_TOKEN,
                                           modee_loc=cfg.MODEL.MODEE.LOC,
                                           use_softmax="regress" in cfg.MODEL.MODEE.LOSS_TYPE,
                                           reconstructor_type=cfg.MODEL.RECONSTRUCTOR.TYPE,
                                           train_head=cfg.MODEL.RECONSTRUCTOR.TRAIN_HEAD,
                                           distill_type=cfg.MODEL.RECONSTRUCTOR.MIMIC_TYPE,
                                           )
        hidden_dim = backbone.embed_dim
        patch_start_index = 1
    
    elif cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_ce_mimic':
        backbone = vit_base_patch16_224_ce_mimic('', drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
                                           ce_loc=cfg.MODEL.BACKBONE.CE_LOC,
                                           ce_keep_ratio=cfg.MODEL.BACKBONE.CE_KEEP_RATIO,
                                           search_size=to_2tuple(cfg.DATA.SEARCH.SIZE),
                                           template_size=to_2tuple(cfg.DATA.TEMPLATE.SIZE),
                                           new_patch_size=cfg.MODEL.BACKBONE.STRIDE,
                                           backbone_type='ostrack_mimic',
                                        #    adapter_type=cfg.TRAIN.PROMPT.TYPE
                                           )
        hidden_dim = backbone.embed_dim
    
    elif cfg.MODEL.BACKBONE.TYPE == 'vit_base_patch16_224_ce_mimic_iou':
        backbone = vit_base_patch16_224_ce_mimic('', drop_path_rate=cfg.TRAIN.DROP_PATH_RATE,
                                           ce_loc=cfg.MODEL.BACKBONE.CE_LOC,
                                           ce_keep_ratio=cfg.MODEL.BACKBONE.CE_KEEP_RATIO,
                                           search_size=to_2tuple(cfg.DATA.SEARCH.SIZE),
                                           template_size=to_2tuple(cfg.DATA.TEMPLATE.SIZE),
                                           new_patch_size=cfg.MODEL.BACKBONE.STRIDE,
                                           backbone_type='ostrack_mimic_iou',
                                        #    adapter_type=cfg.TRAIN.PROMPT.TYPE
                                           )
        hidden_dim = backbone.embed_dim
