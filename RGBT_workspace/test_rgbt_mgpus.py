...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=300, debug=0, script_name='adapter', exit_threshold=0.65):
    ...
    #else:
    seq_txt = seq_name
    save_name = '{}_{}_ep{}_ee{}'.format(script_name, yaml_name, epoch, exit_threshold)
    ...
    if os.path.exists(save_path) and os.path.exists(save_eelayer_path):
        print(f'-1 {seq_name}')
        return
    try:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--yaml_name', type=str, default='rgbt_mimic_fix_ee_stage2_mseloss', help='Name of tracking method.')  # vitb_256_mae_ce_32x4_ep300 vitb_256_mae_ce_32x4_ep60_adapter_i32v21_onlylasher_rgbt
