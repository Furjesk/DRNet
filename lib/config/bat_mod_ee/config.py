...
# MODEL.MODEE
cfg.MODEL.MODEE = edict()
cfg.MODEL.MODEE.TYPE = "linear"
cfg.MODEL.MODEE.HAS_CLS_TOKEN = False
cfg.MODEL.MODEE.LOC = [0]
cfg.MODEL.MODEE.LOSS_TYPE = "cross_entropy"

# RECONSTRUCTOR
cfg.MODEL.RECONSTRUCTOR = edict()
cfg.MODEL.RECONSTRUCTOR.TYPE = None
cfg.MODEL.RECONSTRUCTOR.TRAIN_HEAD = True
cfg.MODEL.RECONSTRUCTOR.LOSS_TYPE = 'mse'
cfg.MODEL.RECONSTRUCTOR.MIMIC_TYPE = 'counterpart'
...
cfg.TRAIN.MODEE_PATH = "/data1/Code/luandong/wangjinhu/DATA/LasHeR_Mod_Use_Label/"
cfg.TRAIN.LR = 0.0001
cfg.TRAIN.RANDOM_EE = False
cfg.TRAIN.STAGE = 1
