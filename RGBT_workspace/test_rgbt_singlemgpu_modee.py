...
from lib.test.tracker.bat_mod_ee_mimic_final import BATModEEMMFinalTrack
...
import lib.test.parameter.bat_mod_ee_mimic_final as bat_mod_ee_mimic_final_params
...
if __name__ == '__main__':
    ...
    parser.add_argument('--script_name', type=str, default='bat_mod_ee', help='Name of tracking method(ostrack, adapter, ftuning).')
    parser.add_argument('--yaml_name', type=str, default='rgbt_loc1_50_token_pred', help='Name of tracking method.')  # rgbt_mimic_fix_ee_stage2_mseloss_discrete2conv,rgbt_mimic_fix_ee_stage2_mseloss_twolinear
    ...
    parser.add_argument('--epoch', default=45, type=int, help='epochs of ckpt')
    ...
    if args.script_name == 'bat':
        ...
        tracker = BAT_RGBT(tracker=mmtrack)
    elif args.script_name == 'bat_mod_ee_mimic_final':
        params = bat_mod_ee_mimic_final_params.parameters(args.yaml_name, args.epoch)
        mmtrack = BATModEEMMFinalTrack(params)  # "GTOT" # dataset_name
        tracker = BAT_RGBT(tracker=mmtrack)
