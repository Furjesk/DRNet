...
def main():
    ...
    parser.add_argument('--script', type=str, help='Name of the train script.')
    ...
    run_training('bat_mod_ee', 'rgbt_loc1_50_new_zero2rgb', cudnn_benchmark=args.cudnn_benchmark,
                 local_rank=args.local_rank, save_dir='./output', base_seed=args.seed,
                 use_lmdb=args.use_lmdb, script_name_prv=args.script_prv, config_name_prv=args.config_prv,
                 use_wandb=args.use_wandb,
                 distill=args.distill, script_teacher=args.script_teacher, config_teacher=args.config_teacher)

'''
CUDA_VISIBLE_DEVICES=0,5 nohup python tracking/train.py --script bat_mod_layer_coee_lu --config rgbt_20_only_layeree_dim0_pred_train_all_mod_hasmimic_final_task_allee --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./rgbt_20_only_layeree_dim0_pred_train_all_mod_hasmimic_final_task_allee.log 2>&1
CUDA_VISIBLE_DEVICES=0 nohup python tracking/train.py --script bat_mod_ee --config rgbt_loc1_50_random --save_dir ./output --mode single --nproc_per_node 1 --use_wandb 0 >./rgbt_loc1_50_random.log 2>&1

CUDA_VISIBLE_DEVICES=4,5 nohup python tracking/train.py --script bat_mod_layer_ee --config rgbt_20_only_layeree_train_all_mod --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./bat_mod_layer_ee_rgbt_20_only_layeree_train_all_mod.log 2>&1
CUDA_VISIBLE_DEVICES=4,5 nohup python tracking/train.py --script bat_mod_layer_ee --config rgbt_20_only_layeree_token_pred --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./bat_mod_layer_ee_rgbt_20_only_layeree_token_pred.log 2>&1
CUDA_VISIBLE_DEVICES=4,5 nohup python tracking/train.py --script bat_mod_layer_ee --config rgbt_20_only_layeree_token_pred_train_all_mod --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./bat_mod_layer_ee_rgbt_20_only_layeree_token_pred_train_all_mod.log 2>&1
CUDA_VISIBLE_DEVICES=4,5 nohup python tracking/train.py --script bat_fix_ee_joint --config rgbt_mimic_fix_ee_joint_train_20_mimic_attn --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./bat_fix_ee_joint_rgbt_mimic_fix_ee_joint_train_20_mimic_attn.log 2>&1
CUDA_VISIBLE_DEVICES=4,5 nohup python tracking/train.py --script bat_fix_ee_joint --config rgbt_mimic_fix_ee_joint_train_20_mimic_attn_cosloss --save_dir ./output --mode multiple --nproc_per_node 2 --use_wandb 0 >./bat_fix_ee_joint_rgbt_mimic_fix_ee_joint_train_20_mimic_attn_cosloss.log 2>&1
'''
